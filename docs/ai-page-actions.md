...
The plugin requires no configuration. Exclusion rules and action definitions are managed centrally in `helper_lib/ai_file_utils/ai_file_actions.json` (see [AI File Utils](helper_library/ai-file-utils.md)).
